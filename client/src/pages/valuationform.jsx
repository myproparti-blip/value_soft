...
const FormPage = ({ user, onLogin }) => {
    ...
    const onFinish = async (e) => {
        ...
        try {
            ...
            // Route BOF Maharashtra forms to the correct service
            if (isBofMaharashtraBank(finalBankName)) {
                console.log("[onFinish] Creating BOF Maharashtra form:", { finalBankName });
                await createBofMaharashtra(payload);
            } else {
                console.log("[onFinish] Creating standard valuation form:", { finalBankName });
